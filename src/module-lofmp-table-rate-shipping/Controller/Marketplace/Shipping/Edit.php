...
use Lofmp\TableRateShipping\Controller\Marketplace\Shipping;
...
class Edit extends Shipping
{
        ...
        if ($id) {
            ...
            if ($this->_session->isLoggedIn() && $status == 1) {
                try {
                    ...
                    $title->prepend(__("Table Rate Shipping"));
    ...
    {
        if (strpos($this->getRequest()->getRequestUri(), 'lofmptablerateshipping/shipping/edit') !== false && !$id) {
