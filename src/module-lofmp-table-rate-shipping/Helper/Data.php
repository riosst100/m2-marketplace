...
namespace Lofmp\TableRateShipping\Helper;
...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getTableRateShippingEnabled()
    {
        return $this->_scopeConfig->getValue(
            'carriers/lofmptablerateshipping/active',
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/lofmptablerateshipping/title',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/lofmptablerateshipping/name',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/lofmptablerateshipping/allowadmin',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        return $this->_scopeConfig->getValue(
            'carriers/lofmptablerateshipping/allow_free_ship_zero_price',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    ...
    {
        try {
            $key = 'shipping/lofmptablerateshipping/active';
