...
define([
    ...
    return Column.extend({
        ...
        getPlaceholderText: function (row) {
            return typeof(row[this.index + '_placehoder']) !== "undefined" ? row[this.index + '_placehoder'] : ""
        },
        getNoteText: function (row) {
            return typeof(row[this.index + '_note']) !== "undefined" ? row[this.index + '_note'] : ""
        },
        preview: function (row) {
            var modalHtml = mageTemplate(
                denyPreviewTemplate,
                {
                    ...
                    placeholdertext: this.getPlaceholderText(row),
                    notetext: this.getNoteText(row),
