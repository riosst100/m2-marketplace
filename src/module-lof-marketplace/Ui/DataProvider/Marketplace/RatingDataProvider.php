...
class RatingDataProvider extends \Lof\MarketPlace\Ui\DataProvider\Seller\RatingDataProvider
{
    /**
     * @var SellerFactory
     */
    ...
    /**
     * Set default sort rating
     *
     * @return $this
     */
    public function setDefaultSortRating()
    {
        // $this->getCollection()->addOrder('main_table.rating_id', 'ASC');
        return $this;
    }
