...
class Orderview extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($customerSession->isLoggedIn() && $status == 1) {
            ...
            $sellerOrder = $this->getSellerOrder($sellerId);
    ...
    /**
     * @param int $sellerId
     * @return \Lof\MarketPlace\Model\Order|null
     */
    public function getSellerOrder($sellerId)
    {
        $foundOrder = $this->_sellerOrder->create()->getCollection()
