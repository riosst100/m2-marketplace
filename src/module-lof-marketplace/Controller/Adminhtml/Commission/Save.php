    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            try {
                ...
                $this->messageManager->addSuccessMessage(__('You saved this commission.'));
                $this->_objectManager->get(\Magento\Backend\Model\Session::class)->setFormData(false);
                if ($this->getRequest()->getParam('back')) {
                    return $resultRedirect->setPath(
                        '*/*/edit',
                        ['commission_id' => $model->getId(), '_current' => true]
                    );
                }
                return $resultRedirect->setPath('*/*/');
            ...
            return $resultRedirect->setPath(
                '*/*/edit',
                ['commission_id' => $this->getRequest()->getParam('commission_id')]
            );
        }
