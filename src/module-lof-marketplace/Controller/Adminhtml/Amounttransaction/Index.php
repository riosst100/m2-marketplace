...
class Index extends \Lof\MarketPlace\Controller\Adminhtml\Amounttransaction
{
    ...
    public function execute()
    {
         ...
         */
        $resultPage->setActiveMenu('TCGCollective_MarketPlace::seller_amount_transaction');
    ...
    {
        return $this->_authorization->isAllowed('TCGCollective_MarketPlace::seller_amount_transaction');
    }
}
