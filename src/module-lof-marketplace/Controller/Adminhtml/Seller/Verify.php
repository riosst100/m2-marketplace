...
class Verify extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            try {
                ...
                $model->setVerifyStatus(1)->save();

                $this->messageManager->addSuccessMessage(__('The seller has been verified.'));
        ...
        $this->messageManager->addErrorMessage(__('We can\'t find a seller to verify.'));
    ...
    {
        return $this->_authorization->isAllowed('Lof_MarketPlace::seller_verify');
    }
}
