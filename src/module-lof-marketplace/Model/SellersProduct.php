...
use Lof\MarketPlace\Api\Data\SellersProductInterface;
 ...
 */
class SellersProduct extends \Magento\Catalog\Model\AbstractModel implements
    IdentityInterface,
    SaleableInterface,
    SellersProductInterface
{
    ...
    /**
     * @var \Magento\Catalog\Model\Product\Url|null
     */
    ...
    /**
     * List of attributes in SellersProductInterface
     * @var array
     */
    protected $interfaceAttributes = [
        SellersProductInterface::SKU,
        SellersProductInterface::NAME,
        SellersProductInterface::PRICE,
        SellersProductInterface::WEIGHT,
        SellersProductInterface::STATUS,
        SellersProductInterface::VISIBILITY,
        SellersProductInterface::ATTRIBUTE_SET_ID,
        SellersProductInterface::TYPE_ID,
        SellersProductInterface::CREATED_AT,
        SellersProductInterface::UPDATED_AT,
        SellersProductInterface::SELLER_ID,
        'media_gallery',
        'tier_price',
    ];
    ...
    public function __construct(
        ...
        \Magento\Catalog\Model\Product\Url $url, //---add \Magento\Catalog\Model\
        \Magento\Catalog\Model\Product\Link $productLink, //---add \Magento\Catalog\Model\
        ...
        \Magento\Catalog\Model\Product\Type $catalogProductType, //----- \Magento\Catalog\Model\
        ...
        \Magento\Catalog\Model\Product\Image\CacheFactory $imageCacheFactory, //add- \Magento\Catalog\Model\
    ...
    /**
     * @return \Magento\Catalog\Model\Product\Url|null
     */
    ...
    public function prepareCustomOptions()
    {
        foreach ($this->getCustomOptions() as $option) {
            if (!empty($option) && is_object($option) && (!is_object($option->getProduct()) || $option->getId())) {
    ...
    /**
     * @return bool|\Magento\Framework\Pricing\PriceInfo\Base
     */
    ...
    public function __toArray()
    {
        ...
        $hasToArray = function ($model) {
            return is_object($model)
                && method_exists($model, '__toArray') && is_callable([$model, '__toArray']);
        };
