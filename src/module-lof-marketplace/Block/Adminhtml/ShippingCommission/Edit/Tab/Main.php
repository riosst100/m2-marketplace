...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var $model \Lof\MarketPlace\Model\ShippingCommission */
        $model = $this->_coreRegistry->registry('lof_marketplace_shipping_commission');

        /**
         * Checking if user have permission to save information
         */
        if ($this->_isAllowedAction('Lof_MarketPlace::shipping_commission_edit')) {
        ...
        if ($model->getId()) {
            $fieldset->addField('shipping_commission_id', 'hidden', ['name' => 'shipping_commission_id']);
        }
