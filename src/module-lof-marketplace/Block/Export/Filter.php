...
class Filter extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        $code = $this->getFilterElementName(
            $attribute->getAttributeCode()
        );
        // phpcs:disable Generic.Files.LineLength.TooLong
        $html = '<input type="text" name="' . $code . '" class="admin__control-text input-text input-text-export-filter"';
        if ($value) {
    ...
    protected function _getNumberFromToHtmlWithValue(Attribute $attribute, $value)
    {
        ...
        return '<strong class="admin__control-support-text">' . __('From') .
            ':</strong>&nbsp;' .
