...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(
        ...
        $table = $setup->getConnection()->
        newTable(
            $setup->getTable('lof_marketplace_sellerinvoice')
        )->addColumn(
            'sellerinvoice_id',
            \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
            null,
        ...
        $table = $setup->getConnection()->
        newTable(
            $setup->getTable('lof_marketplace_sellerpayment')
        )->addColumn(
            'id',
            Table::TYPE_INTEGER,
            null,
        ...
        $table = $setup->getConnection()->
        newTable(
            $setup->getTable('lof_marketplace_refund')
        )->addColumn(
            'refund_id',
            Table::TYPE_INTEGER,
            null,
