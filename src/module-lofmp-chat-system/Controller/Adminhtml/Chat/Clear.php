...
class Clear extends \Magento\Backend\App\Action
{
    ...
    {
        return $this->_authorization->isAllowed('Lofmp_ChatSystem::chat_clear');
    }
    ...
    public function execute()
    {
       /** @var \Magento\Backend\Model\View\Result\Redirect $resultRedirect */
        ...
        try {
            ...
            $collection = $this->_objectManager->create('Lofmp\ChatSystem\Model\ChatMessage')->getCollection();
