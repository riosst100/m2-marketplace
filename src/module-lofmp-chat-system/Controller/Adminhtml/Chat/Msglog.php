...
class Msglog extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        $chat = $this->_objectManager->create('Lofmp\ChatSystem\Model\Chat')->load($id);
        ...
        foreach ($message as $key => $_message) {
            ...
            if ($_message['user_id'])
            {
                ...
                ';
            }else if($_message['seller_id']){
                $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
                $seller = $objectManager->create(\Lof\MarketPlace\Model\Seller::class)->load($_message['seller_id'], 'seller_id');
                echo '
                    <div class="msg">
                        <p>'.$_message['body_msg'].'</p>
                        <div class="info-msg">
