 ...
 */
namespace Lofmp\ChatSystem\Model\ResourceModel\Chat\Grid;
...
use Lofmp\ChatSystem\Model\ResourceModel\Chat\Collection as ChatCollection;
...
class Collection extends ChatCollection implements SearchResultInterface
{
    ...
    protected function _initSelect()
    {
        ...
        $this->join(
            [
                'lms' => $this->getTable('lof_marketplace_seller')
            ],
