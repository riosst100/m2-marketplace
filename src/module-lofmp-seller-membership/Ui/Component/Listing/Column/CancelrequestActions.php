...
class cancelrequestActions extends Column
{
    /** Url path */
    const MENU_URL_PATH_EDIT = 'lofmpsellermembership/cancelrequest/edit';
    const MENU_URL_PATH_DELETE = 'lofmpsellermembership/cancelrequest/delete';
