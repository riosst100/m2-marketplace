...
class SellerComment extends Column
{
    /**
     * @var UrlInterface
     */
    ...
    public function prepareDataSource(array $dataSource)
    {
        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item['customer_comment'])) {
                    $item[$fieldName] = \strip_tags($item['customer_comment']);
                    $item[$fieldName] = $this->helperData->xss_clean($item[$fieldName]);
                }
            }
        }
