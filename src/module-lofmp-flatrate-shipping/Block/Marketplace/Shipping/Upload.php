...
namespace Lofmp\FlatRateShipping\Block\Marketplace\Shipping;
...
class Upload extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Lofmp_FlatRateShipping';
        ...
        $this->buttonList->add(
            ...
            [
                ...
                'class' => 'save primary',
                'onclick' => 'setLocation(\'' . $this->getUrl('lofmpflatrateshipping/*/save_upload') . '\')'
            ]
        );
        $this->buttonList->remove('save');
        $this->buttonList->remove('reset');
        if ($this->_isAllowedAction('Lofmp_FlatRateShipping::shipping_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('lofmpflatrateshipping_shipping')->getId()) {
            return __(
                "Edit Message '%1'",
                $this->escapeHtml($this->_coreRegistry->registry('lofmpflatrateshipping_shipping')->getTitle())
            );
        } else {
