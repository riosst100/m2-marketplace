...
namespace Lofmp\FlatRateShipping\Model\Config\Shipping\Methods;

use Magento\Framework\UrlInterface;

class FlatRate extends \Lof\MarketPlace\Model\Config\Shipping\Methods\AbstractModel
{
    /**
     * @var string
     */
    protected $_code = 'lofmpflatrateshipping';
