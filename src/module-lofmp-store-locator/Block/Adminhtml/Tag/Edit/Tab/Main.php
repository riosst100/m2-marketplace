 ...
 */
namespace Lofmp\StoreLocator\Block\Adminhtml\Tag\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Lofmp\StoreLocator\Model\ResourceModel\Tag\Collection
     */
    ...
    public function __construct(
        ...
        \Lofmp\StoreLocator\Model\ResourceModel\Tag\Collection $storelocatorCollection,
        array $data = []
    ) {
    ...
    protected function _prepareForm()
    {
         ...
         */
        if ($this->_isAllowedAction('Lofmp_StoreLocator::tag_save')) {
