...
namespace Lofmp\StoreLocator\Block\StoreLocator\Seller;

class Editlocator extends \Magento\Framework\View\Element\Template {
    ...
    */
    ...
    public function _prepareLayout() {
        $this->pageConfig->getTitle ()->set(__('Edit Seller Locator'));
