...
{
    /** Url path */
    public const FORM_URL_PATH_EDIT = 'formbuilder/modelcategory/edit';
    public const FORM_URL_PATH_DELETE = 'formbuilder/modelcategory/delete';
    ...
    /**
     * ModelCategoryActions constructor.
