    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * addBehaviorConditions
     * 
     * @param \Magento\Framework\Data\Form $form
     * @param \Lofmp\CouponCode\Model\Rule $model
     * @return void
     */
    protected function addBehaviorConditions(\Magento\Framework\Data\Form $form, \Lofmp\CouponCode\Model\Rule $model) {  
       $renderer = $this->_rendererFieldset->setTemplate(
            ...
            $this->getUrl('sales_rule/promo_quote/newActionHtml/form/rule_actions_fieldset/form_namespace/sellercouponcode_rule_form')
        );
