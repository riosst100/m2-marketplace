    ...
    public function execute()
    {
        ...
        if ($data) {
            try {
                ...
                $data["actions"] = $this->helperData->generateActionCondition($data["actions"], (int)$data['seller_id']);
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('lofmpcouponcode/*/edit', ['coupon_rule_id' => $model->getId()]);
                    return;
                }
                $this->_redirect('lofmpcouponcode/*/');
                return;
                ...
                if (!empty($id)) {
                 $this->_redirect('lofmpcouponcode/*/edit', ['coupon_rule_id' => $id]);
                } else {
                    $this->_redirect('lofmpcouponcode/*/new');
                }
                return;
            } catch (\Exception $e) {
                die($e->getMessage());
                ...
                $this->_redirect('lofmpcouponcode/*/edit', ['coupon_rule_id' => $this->getRequest()->getParam('coupon_rule_id')]);
            }
        }
