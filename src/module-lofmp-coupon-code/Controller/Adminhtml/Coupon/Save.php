        ...
        if ($data) {
            try {
                ...
                if ($id) {
                    ...
                    $model_sale_coupon->setIsPublic($is_public);
                    ...
                    if ($this->getRequest()->getParam('back')) {
                        $this->_redirect('lofmpcouponcode/*/edit', ['couponcode_id' => $model->getId()]);
                        return;
                    }
                }
                ...
                if (!empty($id)) {
                 $this->_redirect('lofmpcouponcode/*/edit', ['couponcode_id' => $id]);
                } else {
                    $this->_redirect('lofmpcouponcode/*/*/');
                }
                return;
                ...
                $this->_redirect('lofmpcouponcode/*/edit', ['couponcode_id' => $this->getRequest()->getParam('couponcode_id')]);
            }
        }
