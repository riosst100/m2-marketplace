...
class Generate extends Action
{
    ...
    /**
     * @var \Lofmp\CouponCode\Helper\Barcode39
     */
    protected $_barcode;
     ...
     * @param \Lofmp\CouponCode\Helper\Barcode39 $dataBarcode
    ...
    public function __construct(
        ...
        \Lofmp\CouponCode\Helper\Barcode39 $dataBarcode,
                ...
                if ($limit_time_generated_coupon <= 0 || ($number_generated_coupon < $limit_time_generated_coupon)) {//check number coupons was generated for same email address
                    ...
                    if (!$coupon_exists) {
                        ...
                        if ($allow_save_log) {
                            ...
                            $log_data['generated_link'] = str_replace([" ", ":", "=", "&", "?"],
                                ["+", "%3A", "%3D", "%26", "%3F"], $track_link);
                        ...
                        if ($allow_send_email) {
                            ...
                            $templateVar = [
                                ...
                                'barcode' => isset($responseData['barcode']) ? $responseData['barcode'] : '',
                                'qrcode' => isset($responseData['track_link']) ? $responseData['track_link'] : '',
                            ...
                            $this->messageManager->addSuccess(__('A coupon code has been sent to %1.',
                                $customer_email));
                    ...
                    $status = 'error';
                    $responseData['message'] = __('The rule limit number coupons were generated for email %1.',
                        $customer_email);
                }
            } else {
                $status = 'error';
