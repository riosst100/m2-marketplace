...
class Collection extends AbstractCollection
{
    ...
    /**
     * get total by email and rule id
     *
     * @param string email
     * @param int $ruleId
     * @return int
    ...
    /**
     * Get rule by coupon code
     *
     * @param string $couponc_code
     * @return Object|array|mixed|null
     */
    public function getByCouponCode($coupon_code)
    {
        $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
        $sellerPost = $objectManager->get('Lofmp\CouponCode\Model\Coupon')->load($coupon_code, 'code');
    ...
    /**
     * join salesrule_coupon table
     *
     * @return $this
     */
    public function joinSalesruleCoupon()
    {
        $this->getSelect()
            ->join(
                ['salesrule_coupon' => $this->getTable("salesrule_coupon")],
