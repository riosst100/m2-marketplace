 ...
 */
namespace Lof\Faq\Model\ResourceModel\TagUser\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Lof\Faq\Model\ResourceModel\TagUser\Collection as TagCollection;
...
class Collection extends TagCollection implements SearchResultInterface
{
    ...
    {
        parent::_initSelect();
        $this->addFieldToFilter('main_table.tag_type', 'user');
        return $this;
    }
