 ...
 */
namespace Lof\Faq\Model\ResourceModel\QuestionUser\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Lof\Faq\Model\ResourceModel\QuestionUser\Collection as QuestionCollection;
...
class Collection extends QuestionCollection implements SearchResultInterface
{
    ...
    {
        parent::_initSelect();
        $this->addFieldToFilter('main_table.question_type', 'user');
        return $this;
    }
