 ...
 */
namespace Lof\Faq\Model\ResourceModel\CategoryUser\Grid;

use Magento\Framework\Api\Search\SearchResultInterface;
use Magento\Framework\Search\AggregationInterface;
use Lof\Faq\Model\ResourceModel\CategoryUser\Collection as CategoryCollection;
...
class Collection extends CategoryCollection implements SearchResultInterface
{
    ...
    {
        parent::_initSelect();
        $this->addFieldToFilter('main_table.category_type', 'user');
        return $this;
    }
