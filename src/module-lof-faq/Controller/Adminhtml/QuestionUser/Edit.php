 ...
 */
namespace Lof\Faq\Controller\Adminhtml\QuestionUser;
...
class Edit extends \Lof\Faq\Controller\Adminhtml\Question
{
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? 'User Help Center | ' . $model->getTitle() : __('User Help Center | New Question'));
        return $resultPage;
    }
}
