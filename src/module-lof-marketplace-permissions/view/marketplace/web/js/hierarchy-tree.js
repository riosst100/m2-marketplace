...
define([
    ...
    'mage/template',
    'text!Lof_MarketPermissions/templates/tooltip.html',
    'Magento_Ui/js/modal/alert',
    'Magento_Ui/js/modal/confirm',
    'Lof_MarketPermissions/js/jstree',
    'hierarchyTreePopup',
    ...
    $.widget('mage.hierarchyTree', {
        ...
        _bindTreeEvents: function () {
            ...
            this.element.on('loaded.jstree', function () {
                if (!$('.seller-admin').length) {
                    $('#seller-tree li a').first().addClass('seller-admin');
                }
        ...
        _editSelf: function (e, params) {
            ...
            if (!this._isEdit(e)) {
                this._openAlert({
                    ...
                    content: $.mage.__('This user cannot be deleted because he/she is a seller admin.')
                });
