...
class MassStatus extends \Magento\Framework\App\Action\Action
{
    ...
    protected function processControllerAction($seller = null) 
    {
        ...
        foreach ($collection as $item) {
            if ($status !== \Lof\Quickrfq\Model\Quickrfq::STATUS_APPROVE && $item->getSellerId() == $seller->getId()) {
        ...
        $this->messageManager->addSuccess(__('A total of %1 record(s) have been changed.', $total));
