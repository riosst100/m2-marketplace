        ...
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                if (isset($item['seller_id'])) {
                    $url = $this->urlBuilder->getUrl('lofmarketplace/seller/edit', ['seller_id' => $item['seller_id']]);
                    $link = '<a href="' . $url . '"">' . $escaper->escapeHtml($item['seller_name']) . '</a>';
                    $item['seller_name'] = $link;
                }
            }
        }
