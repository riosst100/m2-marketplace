...
class MassDelete extends \Lofmp\Rma\Controller\Adminhtml\Reason
{
    /**
     * {@inheritdoc}
     */
    public function execute()
    {
        ...
        if (!is_array($ids)) {
            $this->messageManager->addErrorMessage(__('Please select Reason(s)'));
        } else {
            try {
                foreach ($ids as $id) {
                    /** @var \Lofmp\Rma\Model\Reason $reason */
