...
namespace Lofmp\Faq\Controller\Marketplace\FaqSetting;
...
class EnableProduct extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($id) {
            $productId = $id;
            $statusModel = $this->_objectManager->create('Lofmp\Faq\Model\EnableProduct')->load($productId, "product_id");
            $productModel = $this->_objectManager->create('Lof\MarketPlace\Model\SellerProduct')->load($productId, "product_id");
