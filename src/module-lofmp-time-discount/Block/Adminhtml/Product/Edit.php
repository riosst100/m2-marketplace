...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Lofmp_TimeDiscount::product_save')) { 
        ...
        if ($this->_isAllowedAction('Lofmp_TimeDiscount::product_delete')) {
    ...
    public function getHeader()
    {
        ...
        if ($this->_coreRegistry->registry('lofmptimediscount_product')->getId()) {
    ...
    {
        return $this->getUrl('lofmptimediscount/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
