...
define([
    ...
    'underscore',
    'mage/template',
    'text!Lofmp_SellerIdentificationApproval/template/upload/add-file.html',
    'text!Lofmp_SellerIdentificationApproval/template/upload/attentional-modal.html',
    'text!Lofmp_SellerIdentificationApproval/template/upload/attentional-text.html',
    'text!Lofmp_SellerIdentificationApproval/template/upload/error.html',
    'mage/translate',
    'Magento_Ui/js/modal/modal',
    'Lofmp_SellerIdentificationApproval/js/upload/add-file',
    'Lofmp_SellerIdentificationApproval/js/upload/delete-files'
    ...
    $.widget('mage.addFiles', {
        ...
        _create: function () {
            ...
            this.wrapper = $('[data-role="'+this.options.typeUpload+'-attach-wrapper"]');
            this.wrapFiles = $('[data-role="'+this.options.typeUpload+'-history-added-files"]');
        ...
        _initModal: function () {
            var modalOptions = {
                'type': 'popup',
                'modalClass': 'popup-attentional-upload-error main-popup',
                'responsive': true,
                'innerScroll': true,
        ...
        _addError: function (e, text) {
            ...
            this._removeErrors();
            $(this.wrapFiles).html(_.last(file));
        },
