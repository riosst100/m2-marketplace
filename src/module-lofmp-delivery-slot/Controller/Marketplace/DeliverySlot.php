...
namespace Lofmp\DeliverySlot\Controller\Marketplace;
...
/**
 * DeliverySlot post controller
 * @SuppressWarnings(PHPMD.NumberOfChildren)
 */
abstract class DeliverySlot extends \Magento\Framework\App\Action\Action
{
    const FLAG_IS_URLS_CHECKED = 'check_url_settings';
    const SELLER_RESOURCE = 'Lofmp_DeliverySlot::slots';
    ...
    /**
     * @var \Lofmp\DeliverySlot\Helper\Data|null
     */
     ...
     * @param \Lofmp\DeliverySlot\Helper\Data|null $helperData
     */
    public function __construct(
        ...
        \Lofmp\DeliverySlot\Helper\Data $helperData = null
    ) {
    ...
    {
        if ($this->helperData->getDeliverySlotConfig("enabled") && $this->helperData->getDeliverySlotConfig("allow_seller_manage")) {
            return true;
        }
        return false;
    }
