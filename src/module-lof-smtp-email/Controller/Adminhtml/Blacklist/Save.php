...
class Save extends \Lof\SmtpEmail\Controller\Adminhtml\Blacklist
{
        ...
        if ($data) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('lofsmtpemail/*/edit', ['blacklist_id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                 $this->_redirect('lofsmtpemail/*/edit', ['blacklist_id' => $id]);
                 } else {
                ...
                $this->_redirect('lofsmtpemail/*/edit', ['blacklist_id' => $this->getRequest()->getParam('blacklist_id')]);
            }
        }
