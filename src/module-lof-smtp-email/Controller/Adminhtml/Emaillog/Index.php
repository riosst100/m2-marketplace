...
class Index extends \Lof\SmtpEmail\Controller\Adminhtml\Emaillog
{
   /**
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Emaillog'));


        $resultPage->addBreadcrumb(__('Email Log'),__('Email Log'));
